...
(require (rename-in (only-in "smol-nested-def.rkt" [evaluate evaluate/nested-def])))
(require (rename-in (only-in "smol-isolated-fun.rkt" [evaluate evaluate/isolated-fun])))
(require (rename-in (only-in "smol-lazy.rkt" [evaluate evaluate/lazy])))
(require (rename-in (only-in "smol-flat-env.rkt" [evaluate evaluate/flat-env])))
(require (rename-in (only-in "smol-call-by-ref.rkt" [evaluate evaluate/call-by-ref])))
(require (rename-in (only-in "smol-def-by-ref.rkt" [evaluate evaluate/def-by-ref])))
(require (rename-in (only-in "smol-struct-by-ref.rkt" [evaluate evaluate/struct-by-ref])))
(require (rename-in (only-in "smol-deep-closure.rkt" [evaluate evaluate/deep-closure])))
(require (rename-in (only-in "smol-defs-copy-structs.rkt" [evaluate evaluate/defs-copy-structs])))
(require (rename-in (only-in "smol-calls-copy-structs.rkt" [evaluate evaluate/calls-copy-structs])))
(require (rename-in (only-in "smol-structs-copy-structs.rkt" [evaluate evaluate/structs-copy-structs])))
(require (rename-in (only-in "smol-fun-not-val.rkt" [evaluate evaluate/fun-not-val])))
(require (rename-in (only-in "smol-no-circularity.rkt" [evaluate evaluate/no-circularity])))
